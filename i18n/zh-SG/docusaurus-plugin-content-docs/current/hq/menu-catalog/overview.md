...
- 如果更改会影响现场营运，请在编辑前记录当前状态。

## 本节用途

`Menu Management` 是 HQ 的核心菜单设定区域。
...
菜单目录更改可能会影响收银员浏览、报表结构，以及网上点餐设定。请一次保存一项相关更改，并在目标流程中验证结果。

## 如果出现问题

- 确认商品或分类已经挂到正确的父层结构。
- 在继续编辑更多纪录前，先检查问题是在分类、菜单，还是商品设定。
- 如果核心菜单更改后，顾客端通路看起来不对，请确认是否还需要独立的网上点餐设定。

## 何时需要找老板／管理员

- 您正在更改现场定价、折扣，或促销规则。
- 同一套商品结构会影响多间店铺和多个通路。
- 您无法判断问题是在基础目录，还是在网上点餐设定。
