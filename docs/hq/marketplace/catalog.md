...
- Decide whether you are browsing new options or managing an already subscribed product.
...
`Marketplace` is X1's self-serve extension hub. Use it to browse optional features, integrations, and platform add-ons beyond the base product.
...
- The product affects billing, checkout, or live customer channels.
- You are unsure whether another team already uses the same product.
