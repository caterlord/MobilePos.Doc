...
- Treat billing changes as owner/admin work unless your role explicitly covers finance.
...
### Current plan and subscription summary
...
This page is mainly for review. Subscription management usually happens through [Marketplace](./catalog.md) or [My Subscriptions](./my-subscriptions.md).
...
- The change affects invoices, billing responsibility, or paid subscriptions.
