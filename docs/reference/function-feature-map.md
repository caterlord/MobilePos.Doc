...
| Settings | Language configuration, item-name mapping (`Main`/`Alt`), login quick-switch enablement, POS code, cash register code, rounding controls (`Rounding Method`, `Decimal Places`, `Round For Cash Only`), operation toggles | [Screen Guide: Settings](../client/settings), [Troubleshooting](./troubleshooting) |
