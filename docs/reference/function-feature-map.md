...
| Settings | Language configuration, item-name mapping (`Main`/`Alt`), login quick-switch enablement, POS code, cash register code, operation toggles | [Screen Guide: Settings](../client/settings), [Troubleshooting](./troubleshooting) |
